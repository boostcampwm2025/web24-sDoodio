  ...
  return (
    <div className="bg-bg-normal focus-within:ring-primary-weak flex h-16 w-full items-center gap-2 overflow-hidden rounded-2xl px-6 transition-all focus-within:ring-2">
      <input
        ...
        className="text-headline-1 text-label-normal placeholder:text-primary-weak h-full flex-1 bg-transparent font-semibold outline-none placeholder:font-normal"
      />
      {onDelete && (
        <button
          type="button"
