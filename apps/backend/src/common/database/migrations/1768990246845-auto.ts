...
export class Auto1768990246845 implements MigrationInterface {
  name = 'Auto1768990246845';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "daily_user_stats" ("id" uuid NOT NULL DEFAULT uuidv7(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "statDate" date NOT NULL, "totalCompletedCounts" bigint NOT NULL DEFAULT '0', "behaviorCompletedTopNCounts" jsonb NOT NULL DEFAULT '[]'::jsonb, "goalCompletedTopNCounts" jsonb NOT NULL DEFAULT '[]'::jsonb, "goalCompletedCounts" jsonb NOT NULL DEFAULT '[]'::jsonb, "weeklyDailyDifficultyCompletedCounts" jsonb NOT NULL DEFAULT '[]'::jsonb, "dailyDifficultyCompletedCounts" jsonb NOT NULL DEFAULT '{}'::jsonb, "weeklyDifficultyCompletedCounts" jsonb NOT NULL DEFAULT '{}'::jsonb, "totalDifficultyCompletedCounts" jsonb NOT NULL DEFAULT '{}'::jsonb, "originCompletedRatio" numeric(4,2) NOT NULL DEFAULT '0', "notDoneCounts" jsonb NOT NULL DEFAULT '{}'::jsonb, "completionTimeBuckets" jsonb NOT NULL DEFAULT '{}'::jsonb, "checkInTotal" bigint NOT NULL DEFAULT '0', "duduCatchTotal" bigint NOT NULL DEFAULT '0', "goalCountDegree" "public"."daily_user_stats_goalcountdegree_enum" NOT NULL, "behaviorCountDegree" "public"."daily_user_stats_behaviorcountdegree_enum" NOT NULL, "avgRefreshPerDay" numeric(6,2) NOT NULL DEFAULT '0', "avgCompletedPerDay" numeric(6,2) NOT NULL DEFAULT '0', "userId" uuid, CONSTRAINT "PK_665fa6c6c694d33c4f996228865" PRIMARY KEY ("id"))`,
    );
  }
